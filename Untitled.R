...
years <- 17:24
folder_path <- "/Users/allison/Desktop/Research_BentoLab/SP26/data/dengue"
...
for (year in years) {
  ...
  path <- file.path(folder_path, name)
...
# fwrite
fwrite(combined, file.path(folder_path, "deng_data_2017_2024.csv"))
